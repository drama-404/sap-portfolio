...
// /**
//  * Analytical Annotations for ProjectsAnalytics
//  * Enables aggregation, grouping, and measure calculations
//  *
//  * NOTE: These annotations are for the Analytical List Page (ALP) only.
//  * DO NOT apply to the regular Projects entity used for List Report + Object Page.
//  */
